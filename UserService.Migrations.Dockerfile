...
RUN dotnet ef migrations bundle --project UserService/UserService.csproj -o migrations-bundle
...
COPY --from=build-env /App/UserService/appsettings.json ./appsettings.json