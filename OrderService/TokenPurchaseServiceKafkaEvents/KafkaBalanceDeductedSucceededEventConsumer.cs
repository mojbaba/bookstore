...
public class KafkaBalanceDeductedSucceededEventConsumer(KafkaOptions kafkaOptions, BalanceDeductedSucceededEventHandler handler)
    : BackgroundService
{
    ...
    private void StartConsuming(CancellationToken stoppingToken)
    {
        ...
        consumer.Subscribe(kafkaOptions.Topics.BalanceDeductedTopic);
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var @event =
                    JsonSerializer.Deserialize<BalanceDeductedSucceededEvent>(consumeResult.Message.Value);
